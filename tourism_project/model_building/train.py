...
Xtrain_path = "hf://datasets/diwakarpandey-greatlearning/trip-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/diwakarpandey-greatlearning/trip-prediction/Xtest.csv"
ytrain_path = "hf://datasets/diwakarpandey-greatlearning/trip-prediction/ytrain.csv"
ytest_path = "hf://datasets/diwakarpandey-greatlearning/trip-prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_tripprediction_model_v1.joblib"
    ...
    # create_repo("tripprediction-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_tripprediction_model_v1.joblib",
        path_in_repo="best_tripprediction_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
